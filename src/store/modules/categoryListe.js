...
const getters = {
    ...
    categoryListError: state => state.categoryListError,
...
const actions = {
    ...
    getCategoryList({ commit }) {
        Api.get("/api/category/getCategoryList")
            .then(response => {
            ...
            .catch((error) => {
                commit("SET_CATEGORY_LIST_ERROR", error)
                console.log("error produits liste");
            })
    },
...
const mutations = {
    ...
    // la liste des noms de touts les produits
    SET_CATEGORY_LIST: (state, hasVarList) => (state.categoryList = hasVarList),
    SET_CATEGORY_LIST_ERROR: (state, hasVarListE) => (state.categoryListError = hasVarListE),
    // la liste des noms de touts les produits
