        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            ...
            <v-card-actions class="pa-0">
              ...
              <span class="body-2	font-weight-thin">{{ affiche.id }}</span>
            </v-card-actions>
...
<script>
import newTopSell from './TopSellProduct/TopSellProduct.vue'
...
// import allHeader from "../components/headFootPage/main-header.vue";
  ...
  watch: {
    ...
    produit() {
		console.log("gfdgfgg gari ", );
      console.log(this.produit.produit);
      if (this.produit) {
        this.affiche = this.produit;
		    // this.dispProd = true
		    // this.id_to_send = this.affiche.produit.id;
		    // this.id_receveur = this.produit.produit.utilisateur.id_utilisateur;
      }
    },
  },


	// <!--------SECTION COMPUTED POUR LES GUTTERS------->
  computed: {
    ...mapGetters(["produit"]),
  },
