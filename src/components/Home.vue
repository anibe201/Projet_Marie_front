<template>
  <div>
    <v-carousel hide-delimiters>
      ...
      >
        <v-row
          ...
          justify="center"
        >
          <div class="display-2 white--text pl-5 pr-5 hidden-sm-only"><strong>Bénéficier de 60% de reduction aujourd'hui</strong></div><br/>
        </v-row>
      </v-carousel-item>
      <v-carousel-item
    ...
    <div class="pl-4 pr-4 row" style="margin-bottom: 20px;">
      <div
      ...
      >
        <v-card outlined>
          <v-img
            ...
            height="300px"
          >
            <h1 class="text-center font-size">Oeuf d'Oiseaux</h1>
            <div class="text-center mt-2">
            <router-link to="/category-vollaile">
      ...
      >
        <v-card outlined>
          <v-img
            :src="require('../assets/img/home/deal3.png')"
            class="white--text align-center"
            gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
            height="300px"
          >
            <h1 class="text-center font-size">Oeuf d'oiseau</h1>
            <div class="text-center mt-2">
      ...
      >
        <v-card outlined>
          <v-img
            ...
            height="300px"
          >
            <h1 class="text-center font-size">Oeuf de africain</h1>
            <div class="text-center mt-2">
              <v-btn class="white--text caption"  href="/shop" text>SHOP NOW <v-icon class="white--text caption">mdi-arrow-right</v-icon></v-btn>
            </div>
          </v-img>
      ...
      >
        <v-card>
          ...
          <v-img
            ...
            height="400px"
          >
           <h1 class="text-center font-size">Oeuf de pintate</h1>
      ...
      >
        <v-card>
          <v-img
            ...
            height="400px"
          >
            <h1 class="text-center font-size">Oeuf de cail</h1>
            <div class="text-center">
              <v-btn  href="/shop" class="white--text" outlined>SHOP NOW</v-btn>
            </div>
          </v-img>
...
<script>
import newprod from './NewAddProduct/NewAddProduct.vue'
