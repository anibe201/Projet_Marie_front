        ...
        <b-row align-h="center">
          ...
          <b-col cols="5">
            <div>
              ...
              <h5>
                <b>Prix : </b>{{ displayProduct.amount }} Fcfa
              ...
              <div class="d-flex justify-content-left mt-3">
                ...
                <AddToWishlist
                  ...
                  addedButtonTitle="votre favoris"
                  buttonType="sm"
                  :productId="displayProduct.id"
                />
              </div>
            ...
            <template>
              <v-row justify="center">
                <v-expansion-panels popout>
                  <v-expansion-panel>
                    <v-expansion-panel-header><h3>Plus d'informations</h3></v-expansion-panel-header>
